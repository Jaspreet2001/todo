...
import {signInWithEmailAndPassword,onAuthStateChanged,createUserWithEmailAndPassword,sendPasswordResetEmail
} from "firebase/auth";
      ...
      <div className="login-register-container">
        {isRegistering ? (
          ...
          <>
            ...
            <button className="forget-password-button" onClick={handleForgetPassword}>
              Forget Password
            </button>
            <button
